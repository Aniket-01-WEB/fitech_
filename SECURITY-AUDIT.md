...
- **Problem:** A staff user could create a note/recording whose `r2_key` points at _another_ staff member's uploaded object. The list routes then mint a download URL for it, and deleting the row deletes that object from R2.
