      ...
      <div className="simple-events-header">
        <div className="simple-events-title-wrap">
          ...
          <p className="simple-events-subtitle">
            Explore open-source quantitative engines, cryptographic protocols,
            and AI pipelines built by MATRIX members.
          </p>
        </div>
      ...
      >
        {ALL_PROJECTS.map((proj, idx) => (
          <div key={idx} className="lab-card-container">
            <div
              className="simple-event-card lab-build-card"
              style={{
                display: "flex",
            ...
            >
              ...
              <div className="simple-card-bottom">
                ...
                >
                  {proj.tags.map((t, i) => (
                    <span key={i} className="projects-reveal-card-tag">
                      {t}
                    </span>
                  ))}
                </div>
