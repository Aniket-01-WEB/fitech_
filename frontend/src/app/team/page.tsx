    ...
    <div className="relative w-full min-h-screen bg-[#F2F2F2] text-[#0A0A0A] pt-32 pb-16 md:pt-32 md:pb-20 selection:bg-[#0A0A0A] selection:text-[#FFFFFF]">
      <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
        ...
        <div className="flex items-center justify-between pb-4 mb-10 sm:mb-14 border-b border-[#F2F2F2] font-mono text-[11px] text-[#6B6B6B] tracking-wider uppercase">
          <Link
            href="/"
            className="hover:text-[#0A0A0A] inline-flex items-center gap-2"
          >
            <span>←</span>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-8 sm:mb-10">
          <div>
            ...
            <p className="mt-4 text-sm sm:text-base text-[#4A4A4A] font-sans max-w-2xl leading-relaxed">
              Complete archival register of student fellows, research
              coordinators, and operational officers at Adamas University School
          ...
          <div className="mb-6 sm:mb-8">
            <div className="flex items-center justify-between font-mono text-[10px] text-[#6B6B6B] uppercase tracking-wider pb-2 mb-6 border-b border-[#F2F2F2]">
              <span className="font-bold text-[#0A0A0A]">
                EXECUTIVE FELLOWS | PHOTOGRAPHIC ARCHIVE
              </span>
              <span>PLATE REF: FT-ROSTER.PH</span>
            </div>

            <div
              className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 ${membersWithPhotos.length >= 5 ? "lg:grid-cols-5" : "lg:grid-cols-4"} gap-6`}
            >
              <AnimatePresence mode="popLayout">
                {membersWithPhotos.map((member) => (
                  ...
                  >
                    <span className="absolute top-1.5 left-1.5 font-mono text-[9px] text-[#8A8A8A] select-none">
                      ┌
                    </span>
                    <span className="absolute top-1.5 right-1.5 font-mono text-[9px] text-[#8A8A8A] select-none">
                      ┐
                    </span>
                    <span className="absolute bottom-1.5 left-1.5 font-mono text-[9px] text-[#8A8A8A] select-none">
                      └
                    </span>
                    <span className="absolute bottom-1.5 right-1.5 font-mono text-[9px] text-[#8A8A8A] select-none">
                      ┘
                    </span>
        ...
        <div
          className="bg-[#FFFFFF] border border-[#F2F2F2] p-6 sm:p-8 md:p-10"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-5 mb-6 border-b border-[#F2F2F2]">
            <div>
              ...
              <p className="font-sans text-xs sm:text-sm text-[#4A4A4A] mt-0.5">
                Official registry of student fellows, research coordinators, and
            ...
            <table className="w-full text-left font-mono text-xs">
              <thead>
                <tr className="border-b-2 border-[#0A0A0A] text-[10px] text-[#6B6B6B] uppercase tracking-wider">
                  <th className="py-3 px-4 font-bold text-[#0A0A0A]">
                    FELLOW IDENTITY
                  </th>
                  <th className="py-3 px-4 font-bold text-[#0A0A0A]">
                    GOVERNANCE ROLE
                  </th>
                  <th className="py-3 px-4 font-bold text-[#0A0A0A] hidden md:table-cell">
                    DOMAIN & MANDATE
                  </th>
                  <th className="py-3 px-4 font-bold text-[#0A0A0A] hidden sm:table-cell">
                    CHAPTER
                  </th>
                  <th className="py-3 pl-4 text-right font-bold text-[#0A0A0A]">
                    RECORD
                  </th>
                </tr>
              </thead>
                ...
                {visibleMembers.map((member) => (
                  ...
                  >
                    ...
                    <td className="py-4 px-4 hidden md:table-cell text-[#4A4A4A] text-[11px] leading-snug">
                      ...
                      <div className="text-[#6B6B6B] text-[10px] mt-0.5 max-w-md">
                        {member.bio}
                      </div>
                    </td>
