...
const DOMAINS_INDEX = [
  {
    ...
    details:
      "Covers hardware cache-line optimization, non-blocking queue design, zero-copy packet ingestion, and high-frequency exchange simulation.",
  },
  {
    num: "02",
    code: "MQ",
    ...
    details:
      "Focuses on cross-sectional equity strategies, cointegration trading pairs, order book imbalance metrics, and slippage modeling.",
  },
  {
    num: "03",
    code: "AI",
    ...
    details:
      "Deploys temporal attention networks to capture long-range volatility dependencies, textual sentiment extraction, and synthetic data generation.",
  },
  {
    num: "04",
    code: "QR",
    ...
    details:
      "Calibrates implied volatility smiles across equity and crypto options, computing empirical value-at-risk and conditional tail expectations.",
  },
  {
    num: "05",
    code: "VE",
    ...
    details:
      "Mentors student founders through technical feasibility reviews, regulatory compliance roadmaps, and venture angel syndicate presentations.",
  },
  {
    num: "06",
    code: "BC",
    ...
    details:
      "Implements constant product and concentrated liquidity invariants, Groth16 circuit verifiers, and searcher bots for decentralized venues.",
  },
];
    ...
    >
      <div className="max-w-[1360px] mx-auto px-5 sm:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-6 sm:mb-8">
          ...
          <Link href="/domain" className="stanzza-btn-pill stanzza-btn-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-start">
          ...
          <div
            className="lg:col-span-5 lg:sticky lg:top-36 bg-[#F2F2F2] rounded-3xl border border-[#DADADA] p-8 sm:p-10"
