  ...
  return (
    ...
    >
      <div
        ...
        style={{ maxWidth: "720px", borderRadius: "16px", overflow: "hidden" }}
      >
        <div
          ...
          style={{
            height: "240px",
            background:
              activeRecordingPlayer.banner ||
              "linear-gradient(135deg, #090d16, #0A0A0A)",
            position: "relative",
        ...
        <div className="portal-detail-body">
          <h3 className="portal-detail-title" style={{ fontSize: "24px" }}>
            {activeRecordingPlayer.title}
          </h3>
          <p
            style={{
              color: "#0A0A0A",
          ...
          <p className="portal-detail-desc">
            {activeRecordingPlayer.description}
          </p>

          {activeRecordingPlayer.takeaways &&
            activeRecordingPlayer.takeaways.length > 0 && (
              <div
                style={{
                  marginTop: "20px",
                  background: "#F2F2F2",
