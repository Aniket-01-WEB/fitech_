...
const WEBHOOK_URL =
  "https://script.google.com/macros/s/AKfycbyd1SmdJymqZ1B0Z-d5K0J5N28h-M4jJq1rF-vX1Q1s9J4x2m/exec";
...
export default function JoinModal() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      fetch(WEBHOOK_URL, {
        ...
        /* backup log only — never surfaced */
      });
  ...
  return (
    <div
      className={`join-modal-backdrop ${isJoinModalOpen ? "active" : ""}`}
      onClick={(e) => {
      ...
      <div className="join-modal-container">
        ...
        {!submitted ? (
          <>
            <div className="join-modal-header">
              ...
              <p className="join-modal-subtitle">
                Fill out your academic details to apply for student membership.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label htmlFor="modal-reg">
                    Registration No. <span className="req">*</span>
                  </label>
                  <input
                    type="text"
                    id="modal-reg"
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="e.g. 24CS084"
                    required
                  />
                </div>

                <div className="form-group">
                  <label htmlFor="modal-school">
                ...
                <div className="form-group form-group-full">
                  <label htmlFor="modal-gmail">
                    Official / Personal Gmail <span className="req">*</span>
                  </label>
                  <input
                    type="email"
                    id="modal-gmail"
                ...
                <div className="form-group form-group-full">
                  <label htmlFor="modal-password">
                    Choose a Password <span className="req">*</span>
                  </label>
                  <input
                    type="password"
                    id="modal-password"
                ...
                <div className="form-group form-group-full">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="Quantitative Finance & Algo">
          ...
          <div className="join-success-state">
            ...
            <h3>
              {needsConfirmation ? "Almost there!" : "Application Received!"}
            </h3>
            <p>
              {needsConfirmation
